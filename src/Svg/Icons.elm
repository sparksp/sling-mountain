...
inboxCheck attributes =
    zondicon attributes
        [ Svg.path [ d "M0 2C0 .9.9 0 2 0h16a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm14 12h4V2H2v12h4c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2zM5 9l2-2 2 2 4-4 2 2-6 6-4-4z" ] [] ]
...
-}
info : List (Svg.Attribute msg) -> Html msg
info attributes =
    zondicon attributes
        [ Svg.path [ d "M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM9 11V9h2v6H9v-4zm0-6h2v2H9V5z" ] [] ]
...
-}
pixelPerfect : List (Svg.Attribute msg) -> List (Svg msg) -> Html msg
pixelPerfect attributes icon =
    Svg.svg (viewBox "0 0 512 512" :: fill "currentColor" :: attributes) icon


{-| For icons from [zondicons](https://www.zondicons.com/).
-}
zondicon : List (Svg.Attribute msg) -> List (Svg msg) -> Html msg
